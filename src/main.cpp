/**
 * Code for running the ThingPulse ESPGateway as ESP32-Paxcounter.
 * While this code needs to be flashed on one of the two ESP32 modules,
 * the ESP32-Paxcounter with configuration for the espgateway.h needs
 * to be flashed on the other one.
 * 
 * */
...
void loop() {
  ...
  while (Serial2.available()) {
    ...
    log_v("Sending message: %s", payload.c_str());
